...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Product::create([
            ...
            'price' => 85.00,
            'image_path' => asset('example_images/products/burritos/img1.jpg'),
            'quantity' => 50,
            'status' => 'available',
        ...
        Product::create([
            ...
            'price' => 75.00,
            'image_path' => asset('example_images/products/burritos/img2.png'),
            'quantity' => 45,
            'status' => 'available',
            'business_id' => $business1->id,
        ]);
        ...
        Product::create([
            ...
            'price' => 110.00,
            'image_path' => asset('example_images/products/burritos/img3.jpg'),
            'quantity' => 30,
            'status' => 'available',
            'business_id' => $business1->id,
        ]);
        ...
        Product::create([
            ...
            'price' => 70.00,
            'image_path' => asset('example_images/products/burritos/img4.jpg'),
            'quantity' => 40,
            'status' => 'available',
            'business_id' => $business1->id,
        ]);
        ...
        Product::create([
            ...
            'price' => 60.00,
            'image_path' => asset('example_images/products/tacos/img1.jpg'),
            'quantity' => 80,
            'status' => 'available',
        ...
        Product::create([
            ...
            'price' => 65.00,
            'image_path' => asset('example_images/products/tacos/img2.jpg'),
            'quantity' => 70,
            'status' => 'available',
            'business_id' => $business2->id,
        ]);
        ...
        Product::create([
            ...
            'price' => 90.00,
            'image_path' => asset('example_images/products/tacos/img3.jpg'),
            'quantity' => 35,
            'status' => 'available',
            'business_id' => $business2->id,
        ]);
        ...
        Product::create([
            ...
            'price' => 55.00,
            'image_path' => asset('example_images/products/tacos/img4.jpg'),
            'quantity' => 60,
            'status' => 'available',
            'business_id' => $business2->id,
        ]);
        ...
        Product::create([
            ...
            'price' => 95.00,
            'image_path' => asset('example_images/products/hamburgesa/img1.jpg'),
            'quantity' => 40,
            'status' => 'available',
        ...
        Product::create([
            ...
            'price' => 115.00,
            'image_path' => asset('example_images/products/hamburgesa/img2.jpg'),
            'quantity' => 35,
            'status' => 'available',
            'business_id' => $business3->id,
        ]);
        ...
        Product::create([
            ...
            'price' => 145.00,
            'image_path' => asset('example_images/products/hamburgesa/img3.jpg'),
            'quantity' => 25,
            'status' => 'available',
            'business_id' => $business3->id,
        ]);
        ...
        Product::create([
            ...
            'price' => 105.00,
            'image_path' => asset('example_images/products/hamburgesa/img4.jpg'),
            'quantity' => 30,
            'status' => 'available',
            'business_id' => $business3->id,
        ]);
        ...
        Product::create([
            ...
            'price' => 165.00,
            'image_path' => asset('example_images/products/hamburgesa2/img1.jpg'),
            'quantity' => 20,
            'status' => 'available',
        ...
        Product::create([
            ...
            'price' => 155.00,
            'image_path' => asset('example_images/products/hamburgesa2/img2.jpg'),
            'quantity' => 25,
            'status' => 'available',
            'business_id' => $business4->id,
        ]);
        ...
        Product::create([
            ...
            'price' => 150.00,
            'image_path' => asset('example_images/products/hamburgesa2/img3.jpg'),
            'quantity' => 22,
            'status' => 'available',
            'business_id' => $business4->id,
        ]);
        ...
        Product::create([
            ...
            'price' => 135.00,
            'image_path' => asset('example_images/products/hamburgesa2/img4.jpg'),
            'quantity' => 18,
            'status' => 'available',
            'business_id' => $business4->id,
        ]);
        ...
        Product::create([
            ...
            'price' => 125.00,
            'image_path' => asset('example_images/products/sushi/img1.jpg'),
            'quantity' => 30,
            'status' => 'available',
        ...
        Product::create([
            ...
            'price' => 145.00,
            'image_path' => asset('example_images/products/sushi/img2.jpg'),
            'quantity' => 25,
            'status' => 'available',
            'business_id' => $business5->id,
        ]);
        ...
        Product::create([
            ...
            'price' => 110.00,
            'image_path' => asset('example_images/products/sushi/img3.jpg'),
            'quantity' => 35,
            'status' => 'available',
            'business_id' => $business5->id,
        ]);
        ...
        Product::create([
            ...
            'price' => 185.00,
            'image_path' => asset('example_images/products/sushi/img4.jpg'),
            'quantity' => 20,
            'status' => 'available',
            'business_id' => $business5->id,
        ]);
        ...
        Product::create([
            ...
            'price' => 130.00,
            'image_path' => asset('example_images/products/sushi2/img1.jpg'),
            'quantity' => 28,
            'status' => 'available',
        ...
        Product::create([
            ...
            'price' => 175.00,
            'image_path' => asset('example_images/products/sushi2/img2.jpg'),
            'quantity' => 22,
            'status' => 'available',
            'business_id' => $business6->id,
        ]);
        ...
        Product::create([
            ...
            'price' => 155.00,
            'image_path' => asset('example_images/products/sushi2/img3.jpg'),
            'quantity' => 24,
            'status' => 'available',
            'business_id' => $business6->id,
        ]);
        ...
        Product::create([
            ...
            'price' => 220.00,
            'image_path' => asset('example_images/products/sushi2/img4.jpg'),
            'quantity' => 15,
            'status' => 'available',
            'business_id' => $business6->id,
        ]);
