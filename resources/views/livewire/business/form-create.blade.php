    ...
    <div class="pt-12 px-4 md:px-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
        ...
        <div class="md:col-span-2">
          ...
          <x-input type="text" id="name" wire:model="business.name" placeholder="Ej: Restaurante El Sabor"
        ...
        <div>
          ...
          <div class="relative">
            ...
            <x-input type="tel" id="phone" wire:model="business.phone" placeholder="+1 234 567 8900"
