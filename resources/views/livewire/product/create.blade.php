    ...
    <form wire:submit="store" class="space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="md:col-span-1">
                <div
                    ...
                    @if ($form->image_path && str_starts_with($form->image_path->getMimeType(), 'image/'))
                    ...
                    <input type="file" id="banner" wire:model="form.image_path" class="hidden" accept="image/*" />
                </div>
            ...
            <div class="md:col-span-2 grid grid-cols-1">
                ...
                <div>
                    ...
                    <textarea id="description" wire:model="form.description" class="w-full border-gray-300 rounded-lg p-4" rows=""
                        required></textarea>
        ...
        <div class="flex justify-end space-x-4">
            <a href="{{ route('product.index') }}" wire:navigate
                class="px-6 py-2 rounded-full text-sm font-medium text-gray-600 border border-gray-300">
                Cancelar
            </a>
